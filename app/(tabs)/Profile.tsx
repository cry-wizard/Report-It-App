...
const Profile = () => {
  ...
  try {
    await signOut();
    router.replace("/"); // 👈 make sure "/" goes to your login screen
  } catch (err) {
  ...
  <View style={styles.card}>
    ...
    <Text style={styles.label}>Badges</Text>
      ...
      {/* SignOut Button */}
      <TouchableOpacity style={{backgroundColor:'#0951c6',marginHorizontal:15,padding:10,borderWidth:1,borderRadius:10,marginTop:10}}
